  ...
  var ResponsiveVoice = function () {
          ...
          if (a.iOS9 && !a.iOS9_initialized) {
            ...
            if (b.length > a.CHARACTER_LIMIT) {
              for (var f = b; f.length > a.CHARACTER_LIMIT;) {
                var g = f.search(/[:!?.;]+/),
                  e = '';
                if (g == -1 || g >= a.CHARACTER_LIMIT) g = f.search(/[,]+/);
                g == -1 && f.search(' ') == -1 && (g = 99);
                if (g == -1 || g >= a.CHARACTER_LIMIT) {
                  for (
                    var l = f.split(' '), g = 0;
                    g < l.length && !(e.length + l[g].length + 1 > a.CHARACTER_LIMIT);
                    g++
                  ) e += (g != 0 ? ' ' : '') + l[g];
                }
            ...
            a.multipartText = k;
            c == null
              ? (a.setDefaultVoice('UK English Female'), (g = a.default_rv))
            ...
            f = {};
            if (g.mappedProfile != null) f = g.mappedProfile;
            else if (
            ...
            for (g = 0; g < k.length; g++) {
              if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS)) {
                ...
                (e.rvIndex = g),
                (e.rvTotal = k.length),
                g == 0 && (e.onstart = a.speech_onstart),
                (a.msgparameters.onendcalled = !1),
                d != null
                  ? ((e.voice = typeof d.voice !== 'undefined' ? d.voice : f.systemvoice),
                  g < k.length - 1 && k.length > 1
                    ? ((e.onend = a.onPartEnd),
                  ...
                  (e.pitch = d.pitch != null ? d.pitch : e.pitch),
                  (e.rate = a.iOS
                    ? (d.rate != null ? d.rate * d.rate : 1) * e.rate
                    : (d.rate != null ? d.rate : 1) * e.rate),
                  (e.volume = d.volume != null ? d.volume : e.volume))
                ...
                var e = a.selectBest([f.collectionvoice.pitch, f.systemvoice.pitch, 1]),
                  ...
                  n;
                d != null
                  && ((e *= d.pitch != null ? d.pitch : 1),
                  (l *= d.rate != null ? d.rate : 1),
                  (m *= d.volume != null ? d.volume : 1),
      ...
      a.speech_onstart = function () {
        if (!a.onstartFired) {
          ...
          a.msgparameters.onendcalled = !1;
          if (a.msgparameters != null && a.msgparameters.onstart != null) a.msgparameters.onstart();
        }
      };
      a.fallback_startPart = function () {
        a.fallback_part_index == 0 && a.speech_onstart();
        a.fallback_audio = a.fallback_parts[a.fallback_part_index];
        if (a.fallback_audio == null) a.log('RV: Fallback Audio is not available');
        else {
      ...
      a.Dispatch = function (b) {
        ...
        a.hasOwnProperty(h)
          ...
          (a[h] = setInterval(function () {
            --a[k];
            (a.Dispatch(b) || a[k] < 0) && clearTimeout(a[h]);
          }, 50)));
        return !1;
      };
      ...
      a.selectBest = function (a) {
        for (var b = 0; b < a.length; b++) if (a[b] != null) return a[b];
        return null;
      };
      a.pause = function () {
        a.fallbackMode
        ...
        var d = (function () {
          ...
          u = function (a) {
            ...
            var c = b[1],
              b = b[2];
            return [
              (Number(b) || 0) === 0 ? '' : n[b] + ' hundred ',
              (Number(a) || 0) === 0 ? p[c] : (p[c] && p[c] + ' ') || '',
              n[c + a] || n[a]
            ].join('');
          },
          v = function (a, b) {
